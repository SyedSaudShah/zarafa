...
class Forgetpasswordverication extends StatefulWidget {
  const Forgetpasswordverication({Key? key}) : super(key: key);

  @override
  State<Forgetpasswordverication> createState() =>
      _ForgetpasswordvericationState();
}

class _ForgetpasswordvericationState extends State<Forgetpasswordverication> {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    'Enter the four digits code that you receive on your email ',
